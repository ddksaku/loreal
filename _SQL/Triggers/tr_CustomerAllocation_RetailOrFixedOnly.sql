IF OBJECT_ID ('tr_CustomerAllocation_RetailOrFixedOnly', 'TR') IS NOT NULL
   DROP TRIGGER tr_CustomerAllocation_RetailOrFixedOnly;
GO

CREATE TRIGGER tr_CustomerAllocation_RetailOrFixedOnly
...
BEGIN
	...
	IF @fixedAllocation IS NOT NULL AND @retailUplift IS NOT NULL
		BEGIN
			...
			SET  @errorMsg = dbo.uf_getSystemMessage('tr_CustomerAllocation_RetailOrFixedOnly', null, null, null, null, null, null, null, null)
			RAISERROR (@errorMsg, 16, 15)
			ROLLBACK TRAN
			RETURN	
		END
