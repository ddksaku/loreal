...
{
    [TestFixture]
    class AllocationLogicTest56_12 : TestBase
    {
        [Test]
        public void Allocation()
        {
           ...
           // CustomerGroupAllocation customerGroupAllocation = CreateCustomerGroupAllocation(group1, animationProductDetail1, 500);
            ...
            CustomerAllocation customerAllocation1 = (from p in Db.CustomerAllocations
                                                      ...
                                                      select p).Single();
            customerAllocation1.FixedAllocation = 150;
            ...
            Assert.AreEqual(150, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(100, result6.CalculatedAllocation);
