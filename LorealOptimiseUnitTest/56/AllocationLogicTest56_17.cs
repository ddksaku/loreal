...
{
    [TestFixture]
    class AllocationLogicTest56_17 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1000);
            ...
            CustomerCapacity customerCapacity211 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity212 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity213 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity221 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity222 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity223 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity231 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity232 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity233 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 1000);
            CustomerCapacity customerCapacity211W = CreateCustomerCapacity(customerB1W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            CustomerCapacity customerCapacity212W = CreateCustomerCapacity(customerB2W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            CustomerCapacity customerCapacity213W = CreateCustomerCapacity(customerB3W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            CustomerCapacity customerCapacity221W = CreateCustomerCapacity(customerD1W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            CustomerCapacity customerCapacity222W = CreateCustomerCapacity(customerD2W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            CustomerCapacity customerCapacity223W = CreateCustomerCapacity(customerJ1W, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10000);
            ...
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity211W);
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity212W);
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity213W);
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity221W);
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity222W);
            Db.CustomerCapacities.InsertOnSubmit(customerCapacity223W);
            Db.SubmitChanges();
            ...
            CustomerGroupAllocation customerGroupAllocation1 = (from p in Db.CustomerGroupAllocations
                                                                ...
                                                                select p).Single();
            customerGroupAllocation1.RetailUplift = 4;

            CustomerGroupAllocation customerGroupAllocation2 = (from p in Db.CustomerGroupAllocations
                                                                where p.CustomerGroup == group3 && p.AnimationProductDetail == animationProductDetail1
                                                                select p).Single();

            customerGroupAllocation2.RetailUplift = 2.5;
            Db.SubmitChanges();

            // Customer Allocation
            CustomerAllocation customerAllocation1 = (from p in Db.CustomerAllocations
                                                      where p.Customer == customerB1 && p.AnimationProductDetail == animationProductDetail1
                                                      select p).Single();
            customerAllocation1.RetailUplift = 0;

            CustomerAllocation customerAllocation2 = (from p in Db.CustomerAllocations
                                                      where p.Customer == customerD1 && p.AnimationProductDetail == animationProductDetail1
                                                      select p).Single();
            customerAllocation2.RetailUplift = 3;

            CustomerAllocation customerAllocation3 = (from p in Db.CustomerAllocations
                                                      where p.Customer == customerJ1 && p.AnimationProductDetail == animationProductDetail1
                                                      select p).Single();
            ...
            Assert.AreEqual(0, result1.CalculatedAllocation); 
            ...
            Assert.AreEqual(150, result2.CalculatedAllocation); 
            ...
            Assert.AreEqual(150, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(120, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(40, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(40, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(200, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(100, result8.CalculatedAllocation); //95 in excel
            ...
            Assert.AreEqual(100, result9.CalculatedAllocation); //95 in excel
