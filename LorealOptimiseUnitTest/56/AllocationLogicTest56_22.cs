...
{
    [TestFixture]
    class AllocationLogicTest56_22 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Sales Employee
            SalesEmployee employee = CreateSalesEmployee(division1);
                        

            // Customers            
            Customer customerB1 = CreateCustomer(group1, "Boots 1", "5454", employee, division1);
            Customer customerB2 = CreateCustomer(group1, "Boots 2", "4278", employee, division1);
            Customer customerB3 = CreateCustomer(group1, "Boots 3", "54615", employee, division1);
            Customer customerB1W = CreateCustomer(group1, "Boots Warehouse 1", "54754", employee, division1);
            Customer customerB2W = CreateCustomer(group1, "Boots Warehouse 2", "34278", employee, division1);
            Customer customerB3W = CreateCustomer(group1, "Boots Warehouse 3", "54644515", employee, division1);
            Customer customerD1 = CreateCustomer(group2, "Debenhams 1", "879487", employee, division1);
            Customer customerD2 = CreateCustomer(group2, "Debenhams 2", "65626", employee, division1);
            Customer customerD1W = CreateCustomer(group2, "Debenhams Warehouse 1", "8797487", employee, division1);
            Customer customerD2W = CreateCustomer(group2, "Debenhams Warehouse 2", "656256", employee, division1);
            Customer customerD3 = CreateCustomer(group2, "Debenhams 3", "42718", employee, division1);
            Customer customerJ1 = CreateCustomer(group3, "John Lewis 1", "54165", employee, division1);
            Customer customerJ2 = CreateCustomer(group3, "John Lewis 2", "879817", employee, division1);
            Customer customerJ3 = CreateCustomer(group3, "John Lewis 3", "65606", employee, division1);
            Customer customerJ1W = CreateCustomer(group3, "John Lewis Warehouse 1", "540165", employee, division1);
            ...
            AnimationProductDetail animationProductDetail1 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail1.AllocationQuantity = 150;
            Db.SubmitChanges();
            ...
            CustomerGroupAllocation customerGroupAllocation3 = (from p in Db.CustomerGroupAllocations
            ...
            Assert.AreEqual(50, result4.CalculatedAllocation);
