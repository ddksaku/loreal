...
{
    [TestFixture]
    class AllocationLogicTest56_15 : TestBase
    {
        [Test]
        public void Allocation()
        {
          ...
          // CustomerGroupAllocation customerGroupAllocation1 = CreateCustomerGroupAllocation(group1, animationProductDetail1, 500);
          // CustomerGroupAllocation customerGroupAllocation2 = CreateCustomerGroupAllocation(group2, animationProductDetail1, 200);
            Db.SubmitChanges();
            ...
            CustomerAllocation customerAllocation1 = (from p in Db.CustomerAllocations
                                                      ...
                                                      select p).Single();
            customerAllocation1.RetailUplift = 4;

            CustomerAllocation customerAllocation2 = (from p in Db.CustomerAllocations
                                                      where p.Customer == customerB2 && p.AnimationProductDetail == animationProductDetail1
                                                      select p).Single();
            customerAllocation2.RetailUplift = 2;
            Db.SubmitChanges();
            ...
            CustomerAllocation customerAllocation3 = (from p in Db.CustomerAllocations
                                                      ...
                                                      select p).Single();
            customerAllocation3.RetailUplift = 3;
            Db.SubmitChanges();
            ...
            Assert.AreEqual(235, result1.CalculatedAllocation); //230 in excel sheet
            ...
            Assert.AreEqual(110, result2.CalculatedAllocation); //115 in excel sheet
            ...
            Assert.AreEqual(55, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(180, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(70, result7.CalculatedAllocation);
