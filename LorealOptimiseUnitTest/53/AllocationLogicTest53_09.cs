...
{
    [TestFixture]
    class AllocationLogicTest53_09 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            group1allocation.ManualFixedAllocation = 900;
            ...
            Assert.AreEqual(300, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(300, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(900, result10.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result11.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result12.CalculatedAllocation);
        }
    }
}
