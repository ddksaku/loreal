...
{
    [TestFixture]
    class AllocationLogicTest53_08 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            group1allocation.ManualFixedAllocation = 300;
            group2allocation.ManualFixedAllocation = 100;
            group3allocation.ManualFixedAllocation = 250;
            Db.SubmitChanges();       
            ...
            Assert.AreEqual(34, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(33, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(33, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(84, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(83, result8.CalculatedAllocation);
            ...
            Assert.AreEqual(83, result9.CalculatedAllocation);
            ...
            Assert.AreEqual(300, result10.CalculatedAllocation);
            ...
            Assert.AreEqual(100, result11.CalculatedAllocation);
            ...
            Assert.AreEqual(250, result12.CalculatedAllocation);
