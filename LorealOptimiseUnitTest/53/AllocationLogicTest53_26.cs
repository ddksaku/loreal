...
{
    [TestFixture]
    class AllocationLogicTest53_26 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            CustomerGroupAllocation groupAllocation1 = (from p in Db.CustomerGroupAllocations
                                                        where p.CustomerGroup == group1
                                                        select p).Single();

            CustomerGroupAllocation groupAllocation2 = (from p in Db.CustomerGroupAllocations
                                                        where p.CustomerGroup == group2
                                                        select p).Single();

            CustomerGroupAllocation groupAllocation3 = (from p in Db.CustomerGroupAllocations
                                                        where p.CustomerGroup == group3
                                                        select p).Single();

            groupAllocation1.RetailUplift = 6;
           // allocationB1.FixedAllocation = 100;
            //allocationB2.FixedAllocation = 150;
            //allocationB3.FixedAllocation = 50;

            groupAllocation2.ManualFixedAllocation = 600;
            //allocationD1.RetailUplift = 4;
            //allocationD2.RetailUplift = 3;
           // allocationD3.FixedAllocation = 200;

           // groupAllocation3.ManualFixedAllocation = 200;
            // allocationJL1.RetailUplift = 5;
            //allocationJL2.RetailUplift = 1;
            //allocationJL3.RetailUplift = 4;
            ...
            Assert.AreEqual(86, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(86, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(86, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(200, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(200, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(200, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(14, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(14, result8.CalculatedAllocation);
            ...
            Assert.AreEqual(14, result9.CalculatedAllocation);
