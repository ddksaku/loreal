...
{
    [TestFixture]
    class AllocationLogicTest53_13 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            group1allocation.ManualFixedAllocation = 400;
            group2allocation.ManualFixedAllocation = 300;
            group3allocation.ManualFixedAllocation = 200;
            ...
            Assert.AreEqual(134, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(133, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(133, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(400, result10.CalculatedAllocation);
            ...
            Assert.AreEqual(300, result11.CalculatedAllocation);
            ...
            Assert.AreEqual(200, result12.CalculatedAllocation);
        }
    }
}
