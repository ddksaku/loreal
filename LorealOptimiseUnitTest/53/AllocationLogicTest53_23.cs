...
{
    [TestFixture]
    class AllocationLogicTest53_23 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            groupAllocation1.RetailUplift = 2;
            allocationB1.RetailUplift = 3;
            allocationB2.RetailUplift = 0;
          //allocationB3.RetailUplift = 0;

            //groupAllocation2.RetailUplift = 2;
            allocationD1.RetailUplift = 4;
          //allocationD2.RetailUplift = 3;
            allocationD3.RetailUplift = 0.5;

            groupAllocation3.RetailUplift = 0;
           ...
           //allocationJL3.RetailUplift = 4;
            ...
            Assert.AreEqual(164, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(109, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(219, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(54, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(27, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(273, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(54, result8.CalculatedAllocation);
