...
{
    [TestFixture]
    class AllocationLogicTest55_19 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Animation Product           
            AnimationProduct animationProduct1 = CreateAnimationProduct(division1, animation1, 3, 1, brandAxeX, signature);
            animationProduct1.Category = category1;
            AnimationProduct animationProduct2 = CreateAnimationProduct(division1, animation1, 10, 1, brandAxeY, signature);
            animationProduct2.Category = categoryAll;
            AnimationProduct animationProduct3 = CreateAnimationProduct(division1, animation1, 6, 1, brandAxeZ, signature);
            animationProduct3.Category = category4;
            ...
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 10);
            ...
            CustomerCapacity customerCapacity211 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity212 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity213 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity221 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity222 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity223 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity231 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity232 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            CustomerCapacity customerCapacity233 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 10);
            ...
            // Customer Capacity - AnimationProduct1
            CustomerCapacity customerCapacity311 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity312 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity313 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity321 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity322 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity323 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity331 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity332 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            CustomerCapacity customerCapacity333 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 10);
            ...
            AnimationProductDetail animationProductDetail1 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail1.AllocationQuantity = 21;
            ...
            AnimationProductDetail animationProductDetail2 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail2.AllocationQuantity = 40;
            ...
            Assert.AreEqual(9, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result21.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result22.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result23.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result24.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result321.CalculatedAllocation);
            ...
            Assert.AreEqual(6, result324.CalculatedAllocation);
