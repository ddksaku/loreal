...
{
    [TestFixture]
    class AllocationLogicTest55_18 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            AnimationProductDetail animationProductDetail3 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail3.AllocationQuantity = 20;
            Db.SubmitChanges();
            ...
            Assert.AreEqual(7, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(7, result9.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result324.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result328.CalculatedAllocation);
