...
{
    [TestFixture]
    class AllocationLogicTest55_15 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Animation Product           
            AnimationProduct animationProduct1 = CreateAnimationProduct(division1, animation1, 5, 1, category1, brandAxeX, itemType1);
            AnimationProduct animationProduct2 = CreateAnimationProduct(division1, animation1, 6, 1, category1, brandAxeY, itemType2);
            ...
            AnimationProductDetail animationProductDetail1 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail1.AllocationQuantity = 30;
            ...
            AnimationProductDetail animationProductDetail3 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail3.AllocationQuantity = 27;
            Db.SubmitChanges();
            ...
            Assert.AreEqual(0, result22.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result23.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result24.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result321.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result322.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result324.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result325.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result326.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result328.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result329.CalculatedAllocation);
