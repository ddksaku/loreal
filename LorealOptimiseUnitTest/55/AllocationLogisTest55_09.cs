...
{
    [TestFixture]
    class AllocationLogicTest55_09 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Customer Capacity
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animationType1, priorityA, itemType, 3);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animationType1, priorityA, itemType, 3);
