...
{
    [TestFixture]
    class AllocationLogicTest55_08 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Animation            
            Animation animation1 = CreateAnimation(division1, channel1, animationType2, priorityC);
            ...
            // Animation Product           
            AnimationProduct animationProduct1 = CreateAnimationProduct(division1, animation1, 1, 1, category1, brandAxeX, itemType);
            animationProduct1.ItemType = itemType;
            Db.AnimationProducts.InsertOnSubmit(animationProduct1);
            Db.SubmitChanges();


            // Customer Capacity
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animationType2, priorityC, itemType, 4);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animationType2, priorityC, itemType, 4);
            ...
            Assert.AreEqual(4, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(4, result9.CalculatedAllocation);
