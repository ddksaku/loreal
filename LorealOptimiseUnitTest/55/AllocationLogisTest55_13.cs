...
{
    [TestFixture]
    class AllocationLogicTest55_13 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct1.ItemType, 1);
            ...
            CustomerCapacity customerCapacity211 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity212 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity213 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity221 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity222 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity223 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity231 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity232 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            CustomerCapacity customerCapacity233 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct2.ItemType, 6);
            ...
            // Customer Capacity - AnimationProduct1
            CustomerCapacity customerCapacity311 = CreateCustomerCapacity(customerB1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity312 = CreateCustomerCapacity(customerB2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity313 = CreateCustomerCapacity(customerB3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity321 = CreateCustomerCapacity(customerD1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity322 = CreateCustomerCapacity(customerD2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity323 = CreateCustomerCapacity(customerD3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity331 = CreateCustomerCapacity(customerJ1, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity332 = CreateCustomerCapacity(customerJ2, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            CustomerCapacity customerCapacity333 = CreateCustomerCapacity(customerJ3, animation1.AnimationType, animation1.Priority, animationProduct3.ItemType, 0);
            ...
            AnimationProductDetail animationProductDetail1 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail1.AllocationQuantity = 6;
            ...
            AnimationProductDetail animationProductDetail2 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail2.AllocationQuantity = 45;
            ...
            AnimationProductDetail animationProductDetail3 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail3.AllocationQuantity = 0;
            ...
            Assert.AreEqual(1, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result21.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result22.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result23.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result25.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result26.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result27.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result28.CalculatedAllocation);
            ...
            Assert.AreEqual(5, result29.CalculatedAllocation);
            ...
            Assert.AreEqual(0, result324.CalculatedAllocation);
