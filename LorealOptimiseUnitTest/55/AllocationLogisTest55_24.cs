...
{
    [TestFixture]
    class AllocationLogicTest55_24 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            AnimationProduct animationProduct2 = CreateAnimationProduct(division1, animation1, 1, 1, brandAxeY, signature);
            animationProduct2.Category = categoryAll;
            AnimationProduct animationProduct3 = CreateAnimationProduct(division1, animation1, 1, 1, brandAxeZ, signature);
            ...
            AnimationProductDetail animationProductDetail2 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail2.AllocationQuantity = 70;
            ...
            AnimationProductDetail animationProductDetail3 = (from p in Db.AnimationProductDetails
                                                              ...
                                                              select p).Single();
            animationProductDetail3.AllocationQuantity = 50;
            Db.SubmitChanges();
            ...
            Assert.AreEqual(10, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(7, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(7, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(22, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(8, result8.CalculatedAllocation);
            ...
            Assert.AreEqual(13, result9.CalculatedAllocation);
            ...
            Assert.AreEqual(6, result21.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result22.CalculatedAllocation);
            ...
            Assert.AreEqual(6, result24.CalculatedAllocation);
            ...
            Assert.AreEqual(13, result25.CalculatedAllocation);
            ...
            Assert.AreEqual(21, result26.CalculatedAllocation); //20 in excel file
            ...
            Assert.AreEqual(7, result27.CalculatedAllocation); //7 in excel file
            ...
            Assert.AreEqual(4, result29.CalculatedAllocation);
            ...
            Assert.AreEqual(10, result321.CalculatedAllocation);
            ...
            Assert.AreEqual(6, result322.CalculatedAllocation);
            ...
            Assert.AreEqual(3, result323.CalculatedAllocation);
            ...
            Assert.AreEqual(20, result324.CalculatedAllocation); // in excel is 19
            ...
            Assert.AreEqual(7, result328.CalculatedAllocation); // in excel is 8
            ...
            Assert.AreEqual(4, result329.CalculatedAllocation);
