...
{
    [TestFixture]
    class AllocationLogicTest55_10 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Customer Capacity
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animationType1, priorityB, itemType, 2);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animationType1, priorityB, itemType, 2);
            ...
            Assert.AreEqual(2, result1.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result2.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result3.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result4.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result5.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result6.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result8.CalculatedAllocation);
            ...
            Assert.AreEqual(2, result9.CalculatedAllocation);
