...
{
    [TestFixture]
    class AllocationLogicTest55_11 : TestBase
    {
        [Test]
        public void Allocation()
        {
            ...
            // Animation            
            Animation animation1 = CreateAnimation(division1, channel1, animationType1, priorityC);
            ...
            // Customer Capacity
            CustomerCapacity customerCapacity11 = CreateCustomerCapacity(customerB1, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity12 = CreateCustomerCapacity(customerB2, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity13 = CreateCustomerCapacity(customerB3, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity21 = CreateCustomerCapacity(customerD1, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity22 = CreateCustomerCapacity(customerD2, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity23 = CreateCustomerCapacity(customerD3, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity31 = CreateCustomerCapacity(customerJ1, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity32 = CreateCustomerCapacity(customerJ2, animationType1, priorityC, itemType, 1);
            CustomerCapacity customerCapacity33 = CreateCustomerCapacity(customerJ3, animationType1, priorityC, itemType, 1);
            ...
            Assert.AreEqual(1, result7.CalculatedAllocation);
            ...
            Assert.AreEqual(1, result8.CalculatedAllocation);
